...
class CollegeController extends Controller {
  ...
  private createOne_route = async (
    ...
    const { name, websiteLink } = <CollegeData>request.body;
    ...
    [college, error] = <[College, any]>(
      await asyncHandler(this.service.createOne({ name, websiteLink }))
    );
  ...
  private updateOne_route = async (
    ...
    [college, error] = <[College, any]>(
      await asyncHandler(this.service.updateOne(id, { name, websiteLink }))
    );
